  ...
  return (
    <div className="min-h-screen bg-background flex justify-center items-start py-12 px-4">
      ...
      <div className="bg-background text-foreground max-w-3xl w-full rounded-2xl shadow-xl p-10 space-y-6">
        ...
        <p>
          Welcome to our Discipleship System website. Your privacy is important
        ...
        <section className="space-y-2">
          ...
          <p>
            When you use our website or sign in through Facebook Login, we may
            collect:
          </p>
        ...
        <section className="space-y-2">
          ...
          <p>
            We receive only the basic information you authorize and never post
            to your Facebook account without permission.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            We use secure servers and authentication controls. However, no
            system can guarantee 100% protection.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            Information is kept only while your account is active or as required
            to provide services.
          </p>
        </section>
