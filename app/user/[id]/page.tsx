...
export default function UserProfilePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  useEffect(() => {
    if (personalInfo?.firstName || personalInfo?.lastName) {
      document.title = `${personalInfo.firstName || ""} ${personalInfo.middleName || ""} ${personalInfo.lastName || ""} - Profile`.trim()
    }
  }, [personalInfo])
  ...
  return (
    <>
      <Head>
        <meta name="description" content={`${personalInfo?.firstName} ${personalInfo?.middleName || ""} ${personalInfo?.lastName} - User Profile`} />
      </Head>
      <main className="h-screen w-full flex flex-col overflow-hidden">
        {/* header navigation*/}
        <header className="fixed top-0 z-50 w-full bg-background border-b">
            ...
            <div className="p-5 flex flex-row gap-5 items-start sm:items-center">
              ...
              <div className="flex flex-col">
                ...
                <span className="text-sm opacity-70 flex lg:flex-row lg:gap-2 gap-1 flex-col">
                  <span className="flex flex-row gap-1">ID: {personalInfo?.user?.id || "N/A"}</span>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="rounded-2xl border bg-muted shadow-lg overflow-hidden">
                ...
                <div className="p-5 flex flex-row gap-5 align-middle items-center content-center">
                  ...
                  <div className="flex flex-col">
                    <span className="font-medium">(+63) {personalInfo?.phone || "N/A"}</span>
                    <span className="text-sm opacity-70">{personalInfo?.user?.email || "N/A"}</span>
                  </div>
                </div>
              ...
              <div className="rounded-2xl border bg-muted shadow-lg overflow-hidden">
                ...
                <div className="p-5 flex flex-row gap-5 align-middle items-center content-center">
                  ...
                  <div className="flex flex-col">
                    <span className="font-medium">{personalInfo?.houseNumber} {personalInfo?.barangay}</span>
                    <span className="text-sm opacity-70">{personalInfo?.city} {personalInfo?.country}</span>
                  </div>
                </div>
