...
export default function ProfilePage() {
  ...
  const saveForm = async () => {
    ...
    try {
      ...
      //PUT update data
      try {
        const res = await fetch(`${API_BASE}/api/postgre/personal-info/`, {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  useEffect(() => {
    ...
    const fetchUser = async () => {
      try {
        ...
        let personalInfoRes = await fetch(
        ...
        // 4️⃣ Prefill form
        const defaults = {
          birthday: personalInfo.data.birthday
      ...
      <main className="h-screen w-full flex flex-col overflow-hidden">
        ...
        <div className="min-h-full w-full hide-scrollbar-arrows overflow-y-auto flex-1 pt-15 max-w-6xl mx-auto px-4 pb-10 space-y-6">
          ...
          <div className="sticky top-0 z-40 bg-muted flex flex-wrap justify-between align-middle items-center rounded-2xl border shadow-lg p-5 gap-4 ">
            ...
            {formError && (
              <div
                className="relative border border-red-400 lg:w-[45%] w-[48%] dark:text-red-500 text-red-700  px-4 py-2 rounded"
                role="alert"
              >
              ...
              <section className=" top-4  bg-muted rounded-2xl shadow-lg">
                  ...
                  <div className=" basis-1/2 gap-1 rounded-sm flex flex-col">
                    ...
                    <div className="rounded-sm">
                      <input
                        ...
                        onChange={(e) =>
                          setForm((f) => ({ ...f, mName: e.target.value }))
                        }
                        type="text"
                        className={`bg-background rounded-sm mb-1 w-full px-2 py-1 border ${
                ...
                <div className="w-full px-5 gap-y-2 gap-x-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 lg:gap-5 mt-2  ">
                  ...
                  <div className="flex flex-col gap-1 ">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        ...
                        >
                          {form.birthday &&
                          !isNaN(new Date(form.birthday).getTime())
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    >
                      <SelectTrigger
                        className={`${fieldErrors.gender ? "border border-red-500" : ""}`}
                      >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    >
                      <SelectTrigger
                        className={`${fieldErrors.level ? "border border-red-500" : ""}`}
                      >
                  ...
                  <div className="flex flex-col gap-1 mb-5">
                    ...
                    >
                      <SelectTrigger
                        className={`${fieldErrors.group ? "border border-red-500" : ""}`}
                      >
                ...
                <div className="grid gap-6 md:grid-cols-2">
                  ...
                  <div className="rounded-2xl border  bg-muted shadow-lg overflow-hidden">
                    ...
                    <div className="p-5 flex flex-row gap-5 align-middle items-center content-center">
                      ...
                      <div className="flex flex-col">
                        <span className="font-medium">
                          {form.houseNumber} {form.barangay}{" "}
                        </span>
                        <span className="text-sm opacity-70 flex lg:flex-row lg:gap-2 gap-1 flex-col">
                          ...
                          <IconCopy
                            ...
                            onClick={(e) =>
                              copyToClipboard(
                                `${form?.houseNumber} ${form?.barangay} ${form?.city} ${form?.country}`,
                                () => handleClickNotify(e),
                              )
                            }
                          />
