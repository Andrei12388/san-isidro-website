...
const saveForm = async () => {
             ...
             //validations
              ...
              const requiredFields = ["fName", "lName", "mName","birthday", "age", "gender", "level", "ministry", "group", "phone", "email", "city", "country", "barangay", "houseNumber"];
...
// end save form
 ...
 useEffect(() => {
  ...
  const fetchUser = async () => {
    try {
      ...
      const defaults = {
        ...
        mName: personalInfo.data.middleName ?? "",
  ...
  <div className="relative border border-red-400 lg:w-[45%] w-[48%] dark:text-red-500 text-red-700  px-4 py-2 rounded" role="alert">
      ...
      <div className="p-5 flex flex-row gap-5 items-start sm:items-center">
          ...
          />
              ...
              <div className="flex flex-col ">
                <span className="font-medium">{form?.fName} {form?.mName} {form?.lName}</span>
    ...
    fieldErrors.fName ? "border-red-500" : ""}`}>
        ...
        Middle Initial:
        <div className='rounded-sm'>
          <input value={form.mName} placeholder='Middle Initial . . . ' onChange={(e) => setForm(f => ({ ...f, mName: e.target.value }))} type='text' 
           className={`bg-background rounded-sm mb-1 w-full px-2 py-1 border ${
    fieldErrors.mName ? "border-red-500" : ""
  }`}></input>
        </div>
        </div>
        <div className=' basis-1/2 gap-1 rounded-sm flex flex-col'>
        ...
        <div className='rounded-sm'>
          <input value={form.lName} placeholder='Last Name . . . ' onChange={(e) => setForm(f => ({ ...f, lName: e.target.value }))} type='text' 
           className={`bg-background rounded-sm mb-1 w-full px-2 py-1 border ${
    fieldErrors.lName ? "border-red-500" : ""
  }`}></input>
        </div>
        </div>
      </div>
                      ...
                      <div className=' basis-1/2 gap-1 rounded-sm flex flex-col'>
                                        ...
                                        />
                                              ...
                                              <div className='rounded-sm'>
                                                ...
                                                type='email' 
                                                className={`bg-background rounded-sm w-full px-2 py-2 border ${
                                          fieldErrors.email ? "border-red-500" : ""}`}></input>
                                              </div>
                                              </div>
                      </div>
                      ...
                      <div className=' basis-1/2 gap-1 rounded-sm flex flex-col'>
                                        ...
                                        <div className=' basis-1/2 gap-1 rounded-sm flex flex-col'>
                                              ...
                                              <div className='rounded-sm'>
                                                ...
                                                type='text' 
                                                className={`bg-background rounded-sm w-full px-2 py-2 border ${
                                          fieldErrors.city ? "border-red-500" : ""}`}></input>
                                              </div>
                                              </div>
                      </div>
                     <div className='flex lg:flex-row flex-col px-5 gap-3 justify-between'>
                      <div className=' basis-full gap-1 rounded-sm flex flex-col'>
                                              Barangay
                                            <div className="rounded-sm mb-3">
                                        <input    
                                         type='text'                                   
                                          ...
                                          className={`bg-background rounded-sm w-full px-2 py-2 border ${
                                          fieldErrors.barangay ? "border-red-500" : ""}`}
                                        />
                                      </div>
                                              </div>
                      ...
                      <div className='basis-full gap-1 rounded-sm flex flex-col'>
                                        ...
                                        <input
                                          ...
                                          className={`bg-background rounded-sm w-full px-2 py-2 border ${
                                          fieldErrors.houseNumber ? "border-red-500" : ""}`}
                                        />
                                      </div>
                                              </div>
