  ...
  return (
    <div className="min-h-screen bg-background flex justify-center items-start py-12 px-4">
      <div className="bg-background text-foreground max-w-3xl w-full rounded-2xl shadow-xl p-10 space-y-6">
        ...
        <p>
          Welcome to our Discipleship System website. By accessing or using our
        ...
        <section className="space-y-2">
          ...
          <p>
            This platform is provided to support Christian discipleship,
            communication, and community building. You agree to use the service
        ...
        <section className="space-y-2">
          ...
          <p>
            All website content and materials belong to the Discipleship System
        ...
        <section className="space-y-2">
          ...
          <p>
            ...
            liable for damages resulting from use of the website.
          </p>
        </section>
        ...
        <section className="space-y-2">
          ...
          <p>
            For questions, contact: <strong>jcsgosanisidro@gmail.com</strong>
          </p>
        </section>
      </div>
    </div>
