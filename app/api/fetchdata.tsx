...
export const getUsers = "https://isidro-webapi.onrender.com/users/?skip=0&limit=100"

export const tempUrl = "https://api.open-meteo.com/v1/forecast?latitude=14.2&longitude=121.0&current_weather=true&hourly=temperature_2m"
...
function SampleApi(){
    ...
    return(
<div>
                        {loader ? <p>Loading...</p> : error ? <p>Error loading Data. {errMsg}</p> : <div></div>}
            {data?.map((item: any) => (
