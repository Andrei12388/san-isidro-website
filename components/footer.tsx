    ...
    return (
        <footer className="bg-black flex flex-col py-16 md:py-12 items-start content-start">
            <div className=" w-full flex flex-col items-start px-6">
                ...
                <div className=" my-8 flex flex-wrap justify-center gap-6 text-sm mb-0">
                ...
                <div className=' w-full flex flex-row justify-between items-stretch'>
                    <span className="text-white block text-center text-sm"> © {new Date().getFullYear()} JCSGO: SAN ISIDRO All rights reserved</span>
                    <span className="text-white block text-center text-sm">Developed by: Robert Andrei Bardoquillo </span>
                </div>
