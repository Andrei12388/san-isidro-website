    ...
    <header>
      ...
      >
        {!isLoading && (
          <div
            className={cn(
              "mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12 lg:rounded-2xl lg:border lg:backdrop-blur-lg lg:px-5",
              isScrolled &&
                "lg:bg-background/50 max-w-4xl lg:rounded-2xl lg:border lg:backdrop-blur-lg lg:px-5",
            )}
          >
                ...
                {hideAuth ? (
                  ...
                  <div
                    className={cn(
                      hideAuth
                        ? "hidden"
                        : "lg:absolute lg:top-7 flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit",
                    )}
                  >
                    <Button
                      asChild
